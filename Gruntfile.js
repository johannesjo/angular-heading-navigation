    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            validationMsgs: {
                ...
                tasks: ['ngtemplates:angularHeadingNavigation']
            },
            bower: {
                files: ['bower.json'],
            ...
            unitSingleRunDist: {
                ...
                options: {
                    files: [
                        ...
                        // endbower
                        '<%= appConfig.dist %>/angular-heading-navigation.min.js',
        ...
        copy: {
            ...
            unminifiedJs: {
                files: [
                    ...
                    {
                        flatten: true,
                        src: ['.tmp/concat/angular-heading-navigation.min.js'],
                        dest: '<%= appConfig.dist %>/angular-heading-navigation.js'
                    }
                ]
            },
            ghPages: {
        ...
        bump: {
            options: {
                ...
                commitFiles: [
                    'package.json',
                    'bower.json',
                    'dist/angular-heading-navigation.min.js',
                    'dist/angular-heading-navigation.js'
                ],
                createTag: true,
                tagName: 'v%VERSION%',
                tagMessage: 'Version %VERSION%',
                push: true,
                pushTo: 'git@github.com:johannesjo/angular-heading-navigation.git',
